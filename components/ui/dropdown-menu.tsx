      ...
      <DropdownMenuPrimitive.Portal hostName={portalHost}>
        ...
        >
          <DropdownMenuPrimitive.Content
            ref={ref}
            className={cn(
              "z-50 min-w-[8rem] overflow-hidden rounded-md border border-accent bg-popover p-1 shadow-lg web:data-[side=bottom]:slide-in-from-top-2 web:data-[side=left]:slide-in-from-right-2 web:data-[side=right]:slide-in-from-left-2 web:data-[side=top]:slide-in-from-bottom-2",
              open
                ? "web:animate-in web:fade-in-0 web:zoom-in-95"
...
>(({ className, inset, ...props }, ref) => (
  <TextClassContext.Provider value="select-none text-sm native:text-md native:font-ui-semibold text-popover-foreground web:group-focus:text-accent-foreground">
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-sm native:text-base font-ui-semibold text-foreground web:cursor-default",
      inset && "pl-8",
      className,
    )}
    {...props}
